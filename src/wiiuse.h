...
/** @name Guitar Hero DRUMS button codes */
/** @{ */
// TODO
#define GUITAR_HERO_DRUMS_BUTTON_HIHAT_OPEN 0x3600
//#define GUITAR_HERO_DRUMS_BUTTON_HIHAT      0xB6CC
 //#define GUITAR_HERO_DRUMS_BUTTON_PEDAL      0x0004
 //#define GUITAR_HERO_DRUMS_BUTTON_BLUE       0x0008
 //#define GUITAR_HERO_DRUMS_BUTTON_GREEN      0x0010
 //#define GUITAR_HERO_DRUMS_BUTTON_YELLOW     0x0020
 //#define GUITAR_HERO_DRUMS_BUTTON_RED        0x0040
 //#define GUITAR_HERO_DRUMS_BUTTON_ORANGE     0x0080
#define GUITAR_HERO_DRUMS_BUTTON_PLUS      0x0400
#define GUITAR_HERO_DRUMS_BUTTON_MINUS     0x1000
#define GUITAR_HERO_DRUMS_BUTTON_ORANGE         0x9C00
#define GUITAR_HERO_DRUMS_BUTTON_BLUE           0x9E00
#define GUITAR_HERO_DRUMS_BUTTON_YELLOW         0xA200
#define GUITAR_HERO_DRUMS_BUTTON_GREEN          0xA400
#define GUITAR_HERO_DRUMS_BUTTON_RED            0xB200
#define GUITAR_HERO_DRUMS_BUTTON_PEDAL          0xB600
#define GUITAR_HERO_DRUMS_BUTTON_HIHAT          0xB6C0
// #define GUITAR_HERO_DRUMS_BUTTON_STRUM_DOWN 0x4000
//#define GUITAR_HERO_DRUMS_BUTTON_ALL        0xFEFF
#define GUITAR_HERO_DRUMS_BUTTON_ALL            0xFE00
/** @} */
...
#define EXP_GUITAR_HERO_DRUMS 8
...
#define IS_DRUM_HIT(dev, button) ((dev->btns & 0xFF00) == button)

#define IS_HIHAT_OPEN(dev) ((dev->is_hihat_open)==1)
